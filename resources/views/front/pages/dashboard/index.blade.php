                            ...
                            <div class="slider-container">
                                ...
                                @foreach ($slider as $item)
                                    ...
                                    <div class="slider-item fl-wrap">
                                        <div class="bg"  data-bg="{{asset('galeri/slider/'.$item->file)}}"></div>
                        ...
                        <div class="container">
                            ...
                            <div class="gallery-items fl-wrap mr-bot spad">
                                ...
                                <div class="gallery-item">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            <img  src="{{asset('front/images/all/1.jpg')}}"   alt="">
                                ...
                                <div class="gallery-item gallery-item-second">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            <img  src="{{asset('front/images/bg/1.jpg')}}"   alt="">
                    ...
                    <section class="gray-section">
                        <div class="container">
                            <div class="section-title">
                                <h2>Investasi Yang Ditawarkan</h2>
                                <div class="section-subtitle">Best Invest</div>
                                <span class="section-separator"></span>
                            </div>
                            <div class="row" style="margin-top:-50px;">
                                <div class="col-sm-12 text-center">
                                    <div style="width:70%;margin:0 auto">
                                        <div class="main-search-input fl-wrap" style="margin:0 0 20px 0 !important;width:100%;box-shadow: 0px 0px 0px 10px rgba(90,90,90,0.3);padding-right:0px;border:0px !important">
                                            <div class="main-search-input-item" style="width:20%">
                                                <input type="text" readonly tabindex="0" value="Tampilkan Berdasakan :" style="color:#111;">
                                            </div>
                                            <div style="width:80%;float:right">

                                                <div class="main-search-input-item" style="width:20%">
                                                    <button class="main-search-button btn-filter" style="">Semua</button>
                                                </div>
                                                <div class="main-search-input-item" style="width:20%">
                                                    <button class="main-search-button btn-filter" style="">Short Run</button>
                                                </div>
                                                <div class="main-search-input-item" style="width:20%">
                                                    <button class="main-search-button btn-filter">Long Run</button>
                                                </div>
                                                <div class="main-search-input-item" style="width:20%">
                                                    <button class="main-search-button btn-filter">High Return</button>
                                                </div>
                                                <div class="main-search-input-item" style="width:20%;border-right:0px;">
                                                    <button class="main-search-button btn-filter">Best Form Trial</button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            ...
                                            <div class="geodir-category-content fl-wrap">
                                                ...
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{asset('front/images/avatar/1.jpg')}}" alt=""></a>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="images-collage fl-wrap">
                                        ...
                                        <div class="images-collage-main images-collage-item"><img src="{{asset('front/images/avatar/1.jpg')}}" alt=""></div>
                                        <div class="images-collage-other images-collage-item" data-position-left="23" data-position-top="10" data-zindex="2"><img src="{{asset('front/images/avatar/1.jpg')}}" alt=""></div>
                                        <div class="images-collage-other images-collage-item" data-position-left="62" data-position-top="54" data-zindex="5"><img src="{{asset('front/images/avatar/1.jpg')}}" alt=""></div>
                                        <div class="images-collage-other images-collage-item anim-col" data-position-left="18" data-position-top="70" data-zindex="11"><img src="{{asset('front/images/avatar/1.jpg')}}" alt=""></div>
                                        <div class="images-collage-other images-collage-item" data-position-left="37" data-position-top="90" data-zindex="1"><img src="{{asset('front/images/avatar/1.jpg')}}" alt=""></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <section class="parallax-section" data-scrollax-parent="true">
                        <div class="bg"  data-bg="{{asset('front/images/bg/1.jpg')}}" data-scrollax="properties: { translateY: '100px' }"></div>
                            ...
                            <div class="testimonials-carousel single-carousel fl-wrap">
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="testimonilas-avatar-item">
                                        <div class="testimonilas-avatar"><img src="{{asset('front/images/avatar/1.jpg')}}" alt=""></div>
                                        <h4>Lisa Noory</h4>
                        ...
                        <div class="container">
                            <div class="fl-wrap spons-list">
                                <ul class="client-carousel">
                                    <li><a href="#" target="_blank"><img src="{{asset('front/images/clients/1.png')}}" alt=""></a></li>
                                    <li><a href="#" target="_blank"><img src="{{asset('front/images/clients/1.png')}}" alt=""></a></li>
                                    <li><a href="#" target="_blank"><img src="{{asset('front/images/clients/1.png')}}" alt=""></a></li>
                                    <li><a href="#" target="_blank"><img src="{{asset('front/images/clients/1.png')}}" alt=""></a></li>
                                    <li><a href="#" target="_blank"><img src="{{asset('front/images/clients/1.png')}}" alt=""></a></li>
                                ...
                                <div class="col-md-4">
                                    <article class="card-post">
                                        <div class="card-post-img fl-wrap">
                                            <a href="blog-single.html"><img src="{{asset('front/images/all/1.jpg')}}"   alt=""></a>
                                        </div>
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="blog-single.html">Gallery Post</a></h3>
                                            <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                            <div class="post-author"><a href="#"><img src="{{asset('front/images/avatar/1.jpg')}}" alt=""><span>By , Alisa Noory</span></a></div>
                                            <div class="post-opt">
                                                <ul>
                                ...
                                <div class="col-md-4">
                                    <article class="card-post">
                                        ...
                                        <div class="card-post-content fl-wrap">
                                            ...
                                            <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                            <div class="post-author"><a href="#"><img src="{{asset('front/images/avatar/1.jpg')}}" alt=""><span>By , Mery Lynn</span></a></div>
                                            <div class="post-opt">
                                                <ul>
                                                    <li><i class="fa fa-calendar-check-o"></i> <span>25 April 2018</span></li>
                                                    <li><i class="fa fa-eye"></i> <span>264</span></li>
                                ...
                                <div class="col-md-4">
                                    <article class="card-post">
                                        ...
                                        <div class="card-post-content fl-wrap">
                                            ...
                                            <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                            <div class="post-author"><a href="#"><img src="{{asset('front/images/avatar/1.jpg')}}" alt=""><span>By , Garry Dee</span></a></div>
                                            <div class="post-opt">
                                                <ul>
                                                    <li><i class="fa fa-calendar-check-o"></i> <span>25 April 2018</span></li>
                                                    <li><i class="fa fa-eye"></i> <span>264</span></li>
                    ...
                    <section class="gradient-bg">
                        <div class="cirle-bg">
                            <div class="bg" data-bg="{{asset('front/images/bg/circle.png')}}"></div>
                        </div>
                        <div class="container">
