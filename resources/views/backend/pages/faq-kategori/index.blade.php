		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Tambah Data FAQ Kategori</h4>
				</div>
				<div class="modal-body">
					<form action="{{ route('faq-kategori.store') }}" method="POST">
						@csrf
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Data Kategori</span>
...
@section('footscript')
	<script>
        ...
        $('#table').on('click', '.btn-edit', function(){
            ...
            $.ajax({
                url: "{{ url('backend/faq-kategori') }}/"+id+"/edit",
                success: function(res) {
					$('#form-update').attr('action', "{{ url('backend/faq-kategori') }}/"+id)
        ...
        $('#table').on('click', '.btn-delete', function(){
            var id = $(this).data('value')
			$('#form-delete').attr('action', "{{ url('backend/faq-kategori') }}/"+id)			
        })
	</script>
@endsection