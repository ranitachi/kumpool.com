            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="form-delete" action="{{ route('visi-misi.destroy', $data->id) }}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
                    </div>
                ...
                <div class="user-card p-md">
					<div class="media">
                        <div class="media-body">
                            @if (!is_null($data)) 
                                <a href="{{ route('visi-misi.edit', $data->id) }}" class="btn btn-warning"><i class="fa fa-edit"></i> &nbsp;Ganti Data</a>
                                <a class="btn btn-danger" data-toggle="modal" data-target="#modalhapus" data-value="{{ $data->id }}"><i class="fa fa-edit"></i> &nbsp;Hapus Data</a>
                                
                            @else
                                <a href="{{ route('visi-misi.create') }}" class="btn btn-success"><i class="fa fa-save"></i> &nbsp;Input Data</a>
                            @endif
						</div>
					</div>
                </div>
