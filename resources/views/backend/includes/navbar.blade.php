<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
  ...
  <div class="navbar-header">
    ...
    <a href="{{url('dashboard')}}" class="navbar-brand">
      <span class="brand-icon"><img src="{{ asset('front/images') }}/icon_small.png"></span>
      <span class="brand-name"><div style="margin-top:3px !important;">Kumpool</div></span>
    </a>
  </div><!-- .navbar-header -->
          ...
          <div class="media-group dropdown-menu animated flipInY">
              ...
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="{{ asset('theme/backend') }}/assets/images/221.jpg" alt="">
            ...
            <a href="javascript:void(0)" class="media-group-item">
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="{{ asset('theme/backend') }}/assets/images/205.jpg" alt="">
            ...
            <a href="javascript:void(0)" class="media-group-item">
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="{{ asset('theme/backend') }}/assets/images/207.jpg" alt="">
            ...
            <a href="javascript:void(0)" class="media-group-item">
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="{{ asset('theme/backend') }}/assets/images/211.jpg" alt="">
                    <i class="status status-away"></i>
                  </div>
                </div>
                <div class="media-body">
